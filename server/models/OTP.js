...
const otpTemplate = require("../mail/templates/otpVerificationTemplate");
...
OTPSchema.pre("save", async function (next) {
	...
	if (this.isNew) {
		await sendVerificationEmail(this.email, this.otp);//calling the function with the newly created attributes
	}
	next();
});
